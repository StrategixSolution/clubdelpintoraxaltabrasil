...
//        echo  $this->db->last_query()."<br>"; 
     ...
     public function base_model_valida_recompensas($CorteAnio,$CorteMes,$CorteMesAnterior){
        $SQL = "SELECT count(RecompensaId) as tot FROM Recompensas where RecompensaFechaBaja is null and RecompensaAnio = $CorteAnio and RecompensaMes in ($CorteMesAnterior,$CorteMes) ";
        $query	= $this->db->query($SQL);
//        echo  $this->db->last_query()."<br>"; 
        return $query->row()->tot;
    } 
...
//        echo  $this->db->last_query()."<br>"; 
    ...
    public function base_model_guarda_cortes_detalle($tabla,$data){
        switch ($tabla) {
            ...
            case "CortesCambioEstatusVentasAuditoria": $SQL = "INSERT INTO CortesCambioEstatusVentasAuditoria (CortesCambioEstatusVentaAuditoriaUsuarioIdRegistro,CorteId,VentaId,TarjetaId,VentaUsuarioIdMP,DistribuidorId,VentaNumeroTicket,VentaMontoTicket,VentaFotoTicket,VentaFechaRegistro,VentaUsuarioIdRegistro,VentaFechaBaja,VentaUsuarioIdBaja,VentaTienePromocion,VentaSessionId)  SELECT $data"; break;
            case "CortesBimestralVentas": $SQL = "INSERT INTO CortesBimestralesVentas (CorteId,CorteBimestralVentaTarjetaId,CorteBimestralVentaVentaId,CorteBimestralVentaUsuarioIdMP,CorteBimestralVentaDistribuidorId,CorteBimestralVentaVentaNumeroTicket,CorteBimestralVentaVentaMontoTicket,CorteBimestralVentaMes,CorteBimestralVentaVentaEstatus,CorteBimestralVentaVentaEstatusAuditoria,CorteBimestralVentaFechaRegistro,CorteBimestralVentaUsuarioIdCorte)  VALUES ($data,".$this->session->userdata(funciones_strategix_sitio_alias('s_usuario_id')).")"; break;
            case "CortesBimestralMaestrosPintores": $SQL = "INSERT INTO CortesBimestralesMaestrosPintores (CorteId,CorteBimestralMaestroPintorDistribuidorId,CorteBimestralMaestroPintorUsuarioIdMP,CorteBimestralMaestroPintorCantidadTickets,CorteBimestralMaestroPintorVentaMontoTicket,ReposicionProductoGanadorPremioLugar,CorteBimestralMaestroPintorUsuarioIdRegistroCorte)  VALUES ($data,".$this->session->userdata(funciones_strategix_sitio_alias('s_usuario_id')).")"; break;
            case "CortesBimestralDistribuidores": $SQL = "INSERT INTO CortesBimestralesDistribuidores (CorteId,CorteBimestralDistribuidorDistribuidorId,CorteBimestralDistribuidorCantidadTicktes,CorteBimestralDistribuidorVentaMontoTicket,CorteBimestralDistribuidorUsuarioIdRegistroCorte)  VALUES ($data,".$this->session->userdata(funciones_strategix_sitio_alias('s_usuario_id')).")"; break;
            case "CortesBimestralProductosRegistrados": $SQL = "INSERT INTO CortesBimestralesProductosRegistrados (CorteId,CorteBimestralProductoRegistradoDistribuidorId,CorteBimestralProductoRegistradoUsuarioId,CorteBimestralProductoRegistradoTarjetaId,CorteBimestralProductoRegistradoVentaId,CorteBimestralProductoRegistradoVentaNumeroTicket,CorteBimestralProductoRegistradoVentaMontoTicket,CorteBimestralProductoRegistradoProductoClaseId,CorteBimestralProductoRegistradoProductoMarcaId,CorteBimestralProductoRegistradoVentaDetalleLitros,CorteBimestralProductoRegistradoVentaDetalleCantidad,CorteBimestralProductoRegistradoVentaDetalleLitrosTotal,CorteBimestralProductoRegistradoVentaDetalleMonto,CorteBimestralProductoRegistradoVentaDetalleMontoTotal,CorteBimestralProductoRegistradoVentaEstatus,CorteBimestralProductoRegistradoVentaFechaRegistro,CorteBimestralProductoRegistradoUsuarioIdRegistro) VALUES ($data,".$this->session->userdata(funciones_strategix_sitio_alias('s_usuario_id')).")"; break;
            case "CortesBimestralVentasLitrosClases": $SQL = "INSERT INTO CortesBimestralesVentasLitrosClases (CorteId,CorteBimestralVentaDistribuidorId,CorteBimestralVentaLitroClaseProductoClaseId,CorteBimestralVentaLitroClaseDetalleLitros,CorteBimestralVentaLitroClaseDetalleMonto,CorteBimestralVentaLitroClaseUsuarioIdRegistro) VALUES ($data,".$this->session->userdata(funciones_strategix_sitio_alias('s_usuario_id')).")"; break;
            case "CortesBimestralesPerfiles": $SQL = "INSERT INTO CortesBimestralesPerfiles (CorteId,CortesBimestralPerfilDistribuidorId,CortesBimestralPerfilDetalleUsuarioIdRegistro,CortesBimestralPerfilDistribuidorCantidadTicktes,CortesBimestralPerfilDistribuidorVentaMontoTicket,CortesBimestralPerfilDistribuidorUsuarioIdRegistroCorte) VALUES ($data,".$this->session->userdata(funciones_strategix_sitio_alias('s_usuario_id')).")"; break;
            }
        $query	= $this->db->query($SQL);
        return 1;
    }   
