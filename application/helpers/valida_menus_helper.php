...
function valida_menus($pagina,$perfilId){  
    ...
    switch ($perfilId) {            
        case 1: 
            $seguridad_menu = array('Cero','Usuarios_participantes_cargar_cartas_auditorias_controller','Productos_reposicion_descarga_controller','Ventas_personal_top_controller','Ventas_reporte_ganadores_controller','Reportes_ventas_registradas_controller','Reporte_reposicion_productos_controller','Reporte_reposicion_producto_zona_controller','Reportes_distribuidores_admin1_controller','Tarjetas_controller','Tarjetas_altas_controller','Ventas_auditoria_promociones_controller','Reportes_distribuidores_controller','Reportes_maestro_pintores_controller','Distribuidores_controller','Distribuidores_alta_controller','Distribuidores_modificacion_controller');
