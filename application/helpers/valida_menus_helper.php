...
function valida_menus($pagina,$perfilId){  
    ...
    switch ($perfilId) {            
        ...
        case 5: 
            ...
            break; //EJECUTIVOS
        case 6: 
            $seguridad_menu = array('Cero','Ventas_registro_controller','Ventas_auditoria_rechazados_controller','Ventas_promociones_controller','Productos_reposicion_captura_controller','Reporte_reposicion_productos_controller','Ventas_registro_controller','Productos_reposicion_descarga_controller');
            break; //ADMINISTRADOR DE DISTRIBUIDOR
        case 7: 
            $seguridad_menu = array('Cero','Ventas_registro_controller','Ventas_auditoria_rechazados_controller','Ventas_promociones_controller','Productos_reposicion_captura_controller','Reporte_reposicion_productos_controller','Ventas_registro_controller','Productos_reposicion_descarga_controller');
            break; //PERSONAL DE TIENDA
        case 8: 
            $seguridad_menu = array('Cero','Usuarios_participantes_cargar_cartas_controller','Ventas_registro_controller','Ventas_auditoria_rechazados_controller','Ventas_promociones_controller','Productos_reposicion_captura_controller','Reporte_reposicion_productos_controller','Ventas_registro_controller','Productos_reposicion_descarga_controller');
