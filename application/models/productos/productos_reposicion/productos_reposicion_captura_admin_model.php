...
class productos_reposicion_captura_admin_model extends Base_Model {	
    public function __construct(){
        parent::__construct();
    }
    public function productos_reposicion_captura_admin_model_ganador($ReposicionProductoGanadorTotalProductoPremio,$ReposicionProductoGanadorFechaEntregaTienda,$ReposicionProductoGanadorId,$ReposicionProductoPremioProductoId,$DistribuidorId){
...
//        echo  $this->db->last_query()."<br>";         
    ...
    public function productos_reposicion_captura_admin_model_datos_foto($values){
...
//        echo  $this->db->last_query()."<br>";         
     ...
     public function productos_reposicion_captura_admin_model_cmbanio($distribuidor){
         $SQL = "SELECT DISTINCT ReposicionProductoGanadorAnio AS anio FROM ReposicionesProductosGanadores WHERE DistribuidorId = $distribuidor";
        $query	= $this->db->query($SQL);
//        echo  $this->db->last_query()."<br>";         
        return $query->result();
    }
    public function productos_reposicion_captura_admin_model_cmbmes($cmb_distribuidor,$anio){
         $SQL = "SELECT DISTINCT ReposicionProductoGanadorMes AS mes FROM ReposicionesProductosGanadores WHERE ReposicionProductoGanadorAnio = $anio AND DistribuidorId = $cmb_distribuidor";
        $query	= $this->db->query($SQL);
//        echo  $this->db->last_query()."<br>";         
        return $query->result();
    }
    public function productos_reposicion_captura_admin_model_distribuidor(){
        $SQL = "SELECT DISTINCT DistribuidoresDetalles.DistribuidorDetalleRazonSocial,DistribuidoresDetalles.DistribuidorDetalleNombreComercial, DistribuidoresDetalles.DistribuidorId FROM UsuariosDistribuidores INNER JOIN DistribuidoresDetalles ON UsuariosDistribuidores.DistribuidorId = DistribuidoresDetalles.DistribuidorId";
        $query	= $this->db->query($SQL);
//        echo  $this->db->last_query()."<br>"; 
        return $query->result();
    }
    public function productos_reposicion_captura_admin_model_cmb_division(){
        $SQL = "SELECT        ProductoDivisionNombre, ProductoDivisionId FROM ProductosDivisiones";
        $query	= $this->db->query($SQL);
//        echo  $this->db->last_query()."<br>"; 
        return $query->result();    
    }
    public function productos_reposicion_captura_admin_model_cmb_participantes($mes,$anio,$cmb_distribuidor){
        $SQL = "SELECT distinct       ReposicionesProductosGanadores.ReposicionProductoGanadorId, ReposicionesProductosGanadores.ReposicionProductoGanadorPremioLugar, ReposicionesProductosGanadores.TarjetaId, UsuariosDetalles.UsuarioDetalleNombre
                ...
                WHERE ReposicionesProductosGanadores.DistribuidorId = $cmb_distribuidor AND ReposicionesProductosGanadores.ReposicionProductoGanadorMes = $mes AND ReposicionesProductosGanadores.ReposicionProductoGanadorAnio = $anio AND UsuariosDetalles.UsuarioDetalleFechaBaja IS NULL  AND Usuarios.UsuarioFechaBajaParticipante IS NULL AND Usuarios.UsuarioFechaBajaDistribuidora IS NULL AND Tarjetas.TarjetaFechaBaja IS NULL order by ReposicionProductoGanadorPremioLugar";
        $query	= $this->db->query($SQL);
        //echo  $this->db->last_query()."<br>"; 
        return $query->result();    
    }

        public function productos_reposicion_captura_admin_model_fecha_inicio($mes,$anio,$idDitri){
...
//        echo  $this->db->last_query()."<br>"; 
    ...
    public function productos_reposicion_captura_admin_model_cmb_premio($mes,$anio,$lugar){
    ...
    public function productos_reposicion_captura_admin_model_premio_descripcion($ReposicionProductoPremioProductoId){
    ...
    public function productos_reposicion_captura_admin_model_ganador_lugar($ReposicionProductoGanadorId){
    ...
    public function productos_reposicion_captura_admin_model_tabla_productos_Premios($mes,$anio,$lugar,$division){
    ...
    public function productos_reposicion_captura_admin_model_lugar($idganador){
...
//        echo  $this->db->last_query()."<br>"; 
    ...
    public function productos_reposicion_captura_admin_model_entrega($idganador){
...
//        echo  $this->db->last_query()."<br>"; 
    ...
    public function productos_reposicion_captura_admin_model_producto_premioId($mes,$anio,$lugar,$division){
