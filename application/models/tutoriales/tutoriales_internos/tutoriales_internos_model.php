...
class Tutoriales_internos_model extends Base_Model {	
    public function __construct(){ parent::__construct(); }
    public function tutoriales_internos_model_datos(){
        $SQL = "SELECT 
                ...
                AND (CargasMultimedias.CargaMultimediaVideoTipoId IN (1,2)) 
