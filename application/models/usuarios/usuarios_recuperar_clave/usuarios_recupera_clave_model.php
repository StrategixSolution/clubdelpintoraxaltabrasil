...
class Usuarios_recupera_clave_model extends Base_Model {	
    ...
    public function usuarios_recupera_clave_model_datos_mail($email){
        ...
        $SQL    = "SELECT Usuarios.UsuarioId,Usuarios.UsuarioSessionId, Perfiles.PerfilDescripcion, UsuariosDetalles.UsuarioDetalleNombre, 
                  UsuariosDetalles.UsuarioDetalleSegundoNombre, UsuariosDetalles.UsuarioDetalleApellidoPaterno, UsuariosDetalles.UsuarioDetalleApellidoMaterno, UsuariosDetalles.UsuarioDetalleUsuario, UsuariosDetalles.UsuarioDetalleClave, 
    ...
    public function usuarios_recupera_clave_model_data_whatsapp($whatsapp){
        ...
        $SQL    = "SELECT  Usuarios.UsuarioId,  Usuarios.UsuarioSessionId, UsuariosDetalles.UsuarioDetalleNombre, UsuariosDetalles.UsuarioDetalleSegundoNombre, UsuariosDetalles.UsuarioDetalleApellidoPaterno, UsuariosDetalles.UsuarioDetalleApellidoMaterno, 
            UsuariosDetalles.UsuarioDetalleUsuario, UsuariosDetalles.UsuarioDetalleClave, UsuariosDetalles.UsuarioDetalleEmail,UsuariosDetalles.UsuarioDetalleCelular
