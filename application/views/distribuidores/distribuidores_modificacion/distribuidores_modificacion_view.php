              ...
              <div class="row" style="margin-top:20px; text-align:center;">
                <div class="col-lg-2 offset-lg-8 col-6">
                  <button type="button"
                    ...
                    <?= $this->lang->line('distribuidores_modificacion_controller_lang_boton_regresar') ?></button>
                </div>
                <div class="col-lg-2 col-6">
                  <button type="button" id="distribuidores_modificacion_boton_guardar" class="btn btn-axalta"><i
                      class="far fa-save"></i>
                    <?= $this->lang->line('distribuidores_modificacion_controller_lang_boton_guardar') ?></button>
                </div>
              </div>
            </div>
          </div>
