        ...
        <div class="panel-white">
            <div class="row">
                ...
                <div class="col-lg-2" style="text-align: right; display: none;" id="div_buscar">
                    <div class="form-group">
                        <button type="button" id="reporte_ventas_ganadores_btn_buscar" class="btn btn-axalta btn-buscar-ancho" style="margin-top: 20px;"><i class="fas fa-search"></i><span class="btn-buscar-texto">PROCURAR</span></button>
                    </div>
                </div>
            </div>
