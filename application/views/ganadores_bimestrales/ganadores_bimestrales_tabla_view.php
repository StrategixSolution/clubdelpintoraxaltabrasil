...
<div class="row mb-5" style="justify-content: flex-end; margin-top:20px;">
    <div class="col-lg-2">
        <?php if ($cuenta > 0) { ?>
            <button type="button" id="ganadores_bimestrales_btn_mail" class="btn btn-axalta btn-buscar-ancho"><i class="fas fa-envelope pr-5"></i><span class="btn-buscar-texto">ENVIAR MAIL</span></button>
        <?php } ?>
    </div>
</div>
