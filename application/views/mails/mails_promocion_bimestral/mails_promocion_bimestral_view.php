...
<head>
    ...
    <title>CDP Brasil Promo bimestral</title>
    <!--[if (mso 16)]>
    <style type="text/css">
...
<body style="width:100%;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
    <div dir="ltr" class="es-wrapper-color" lang="en" style="background-color:#E9EAE7">
        <!--[if gte mso 9]>
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top" style="padding:0;Margin:0;width:600px">
                                                                        <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" style="padding:0;Margin:0;font-size:0px"><img class="adapt-img" src="<?= $file ?>" alt="" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="600"></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
...
<body style="font-family:'poppins',sans-serif;">
    <table width='600' border='0' align='center' cellpadding='0' cellspacing='0'
        style='border:thin solid #CCC; border-radius:5px 5px 0px 0px;'>
        <tr>
            <td>
                <table width='600' border='0' align='center' cellpadding='0' cellspacing='0'
                    style='padding: 0px 10px 40px 10px; text-align: center;'>
                    <tr>
                        <td><img src="<?= $file ?>" width='600' style='border-radius:5px 5px 0px 0px;'></td>
                    </tr>
                    <tr>
                        <td><img src="<?= funciones_strategix_version_url_random_base_url("application/views/template/sistema/imagenes/mail_footer.png") ?>" width='600'></td>
                    </tr>
                </table>
            </td>
        </tr>
