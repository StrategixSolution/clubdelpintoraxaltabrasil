...
<div class="col-lg-3 col-12">
    <div class="form-group">
        ...
        <select id="multimedios_cargas_form_view_cmb_tipos" name="multimedios_cargas_form_view_cmb_tipos"
            class="chosen-select form-select" data-placeholder="<?=$this->lang->line('multimedios_cargas_controller_lang_etiqueta_tipos')?>" tabindex="2"></select>
        <div id="error"></div>
    </div>
</div>
<span id="popup_view_form" style="display: none;">
    <!--<div class="col-lg-3 col-12">
    <div class="form-group">
        <label for="multimedios_cargas_form_view_cmb_division">DIVISIÓN</label>
        <select id="multimedios_cargas_form_view_cmb_division" name="multimedios_cargas_form_view_cmb_division" class="chosen-select form-select" data-placeholder="TODOS" tabindex="2"></select>
        <div id="error"></div>
    </div>
    </div>-->
    <div class="col-lg-3 col-12">
        <div class="form-group">
            <label for="multimedios_cargas_form_view_cmb_noticia_tipos"><?=$this->lang->line('multimedios_cargas_controller_lang_etiqueta_noticia_tipos')?></label>
            <select id="multimedios_cargas_form_view_cmb_noticia_tipos" name="multimedios_cargas_form_view_cmb_noticia_tipos"
                class="chosen-select form-select" data-placeholder="<?=$this->lang->line('multimedios_cargas_controller_lang_etiqueta_noticia_tipos')?>" tabindex="2"></select>
            <div id="error"></div>
        </div>
    </div>
    <div class="col-lg-4 col-12" id="popup_view_form_archivo" style="display: none;">
        <div class="form-group">
            <label for="multimedios_cargas_form_view_file"><?=$this->lang->line('multimedios_cargas_controller_lang_etiqueta_archivo')?></label>
            <input type="file" name="multimedios_cargas_form_view_file" id="multimedios_cargas_form_view_file"
                class="form-control" placeholder="<?=$this->lang->line('multimedios_cargas_controller_lang_etiqueta_archivo')?>">
            <div id="error"></div>
        </div>
    </div>
    <!--<div class="col-lg-3 col-12">
        <div class="form-group">
            <label for="multimedios_cargas_form_view_file2"><?=$this->lang->line('multimedios_cargas_controller_lang_etiqueta_thumbnail')?></label>
            <input type="file" name="multimedios_cargas_form_view_file2" id="multimedios_cargas_form_view_file2"
                class="form-control" placeholder="<?=$this->lang->line('multimedios_cargas_controller_lang_etiqueta_thumbnail')?>">
            <div id="error"></div>
        </div>
    </div>-->
    <div class="col-lg-2">
        <div class="form-group" >
            <button type="submit" id="multimedios_cargas_popup_form_view_btn_guardar" class="btn btn-axalta btn-buscar-ancho" style="margin-top:20px;"><i class="far fa-save"></i> <span class="btn-buscar-texto"><?=$this->lang->line('multimedios_cargas_controller_lang_btn_guardar')?></span></button>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#multimedios_cargas_popup_form_view_btn_guardar").click(function(e) {
            ...
            if (multimedios_cargas_form_view_js_valida_perfiles() == 0) {
                ...
                multimedios_cargas_form_notificaciones_view_js_guarda_archivo();
            }

        });
        multimedios_cargas_form_notificaciones_view_js_combo_tipos();
        multimedios_cargas_form_notificaciones_view_js_combo_noticia_tipos();
        $('#multimedios_cargas_form_view_cmb_tipos').on('change', function() {
            $('#multimedios_cargas_form_view_file').val('');
            $('#multimedios_cargas_form_view_file2').val('');
    ...
    function multimedios_cargas_form_notificaciones_view_js_combo_tipos() {
        $('#loader_panel').show();
    ...
    function multimedios_cargas_form_notificaciones_view_js_combo_noticia_tipos() {
        $('#loader_panel').show();
        $.ajax({
            type: 'POST',
            url: 'multimedios/multimedios_cargas_controller/multimedios_cargas_controller_combo_noticia_tipos',
            dataType: 'json',
            data: {
                1: 1
            },
            success: function(data) {
                $('#multimedios_cargas_form_view_cmb_noticia_tipos').empty();
                $('#multimedios_cargas_form_view_cmb_noticia_tipos').html(data);
            },
            error: function(data) {},
            complete: function() {
                $('#loader_panel').hide();
    ...
    function multimedios_cargas_form_notificaciones_view_js_guarda_archivo() {
    ...
    /* function multimedios_cargas_form_notificaciones_view_js_guarda_valida_archivo() {
         var multimedios_cargas_form_view_file = $('#multimedios_cargas_form_view_file').val();
         var multimedios_cargas_form_view_file2 = $('#multimedios_cargas_form_view_file2').val();
         var tipos = $('#multimedios_cargas_form_view_cmb_tipos').val();
         if (tipos == 4) {
             if (multimedios_cargas_form_view_file2 == "") {
                 return false;
             }
         } else {
             if (multimedios_cargas_form_view_file == "" && multimedios_cargas_form_view_file2 == "") {
                 return false;
             }
         }
         return true;
