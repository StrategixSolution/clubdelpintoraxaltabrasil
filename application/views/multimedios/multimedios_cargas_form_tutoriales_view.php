...
<span id="popup_view_form" style="display: none;">
    ...
    <div class="col-lg-2 col-12">
        <div class="form-group">
            <label for="multimedios_cargas_form_view_cmb_tipo_video"><?=$this->lang->line('multimedios_cargas_controller_lang_etiqueta_tipo_video')?></label>
            <select id="multimedios_cargas_form_view_cmb_tipo_video" name="multimedios_cargas_form_view_cmb_tipo_video" class="chosen-select form-select" data-placeholder="<?=$this->lang->line('multimedios_cargas_controller_lang_placeholder_tipo_video')?>" tabindex="2"></select>
            <div id="error"></div>
        </div>
    </div>
    <div class="col-lg-4 col-12">
        <div class="form-group">
            <label for="multimedios_cargas_form_view_txt_titulo"><?=$this->lang->line('multimedios_cargas_controller_lang_etiqueta_titulo')?></label>
            <input type="text" name="multimedios_cargas_form_view_txt_titulo" id="multimedios_cargas_form_view_txt_titulo" class="form-control txt-mayus" placeholder="<?=$this->lang->line('multimedios_cargas_controller_lang_placeholder_titulo')?>" maxlength="50">
            <div id="error"></div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        // multimedios_cargas_form_view_js_combo_division();
        multimedios_cargas_form_view_js_combo_tipo_video();
    ...
    /*  function multimedios_cargas_form_view_js_combo_division() {
          $('#loader_panel').show();
          $.ajax({
              type: 'POST',
    ...
    function multimedios_cargas_form_view_js_combo_tipo_video() {
        $('#loader_panel').show();
        $.ajax({
            type: 'POST',
            url: 'multimedios/multimedios_cargas_controller/multimedios_cargas_controller_combo_tipo_video',
            dataType: 'json',
            data: {
                id: 0
            },
            success: function(data) {
                $('#multimedios_cargas_form_view_cmb_tipo_video').empty();
                $('#multimedios_cargas_form_view_cmb_tipo_video').html(data);
            },
            error: function(data) {},
            complete: function() {
                $('#loader_panel').hide();
                            ...
                            Swal.fire({
                                ...
                                if (validaestatus.isConfirmed) {
                                    ...
                                    /*    $('#multimedios_cargas_form_view_tabla').empty();
                                        ...
                                        $('#multimedios_cargas_form_view_cmb_tipo_video').val(0); 
                                        $('#multimedios_cargas_form_view_txt_titulo').val(''); */
