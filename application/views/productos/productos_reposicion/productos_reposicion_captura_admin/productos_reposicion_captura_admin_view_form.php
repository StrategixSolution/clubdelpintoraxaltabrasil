                ...
                <div class="row row-validator">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="form-group">
                            ...
                            <select id="cmb_anio" name="cmb_anio" class="form-select">
                                <option value='0'><?= $this->lang->line('productos_reposicion_captura_controller_lang_placeholder_anio') ?></option>
                            </select>
                            <div id="error"></div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">
                        <div class="form-group">
                            ...
                            <select id="cmb_mes" name="cmb_mes" class="form-select">
                                <option value='0'><?= $this->lang->line('productos_reposicion_captura_controller_lang_placeholder_mes') ?></option>
                            </select>
                            <div id="error"></div>
                        </div>
                    </div>
                ...
                <main>
                    <article class="cargaDocumentos">
                        ...
                        <div class="carga panel-gray">
                            ...
                            <P>
                            <div id="zonaUpload">
                                <form action="<?= base_url('productos/productos_reposicion/productos_reposicion_captura/productos_reposicion_captura_admin_controller/productos_reposicion_captura_admin_controller_cargas_upload_archivo_fisico') ?>" class="dropzone" id="frmProductosReposicionCaptura">
...
<script>
    ...
    $(document).ready(function() {
        ProductosReposicionAdminCaptura_js_combo_distribuidora();
        $('#cmb_distribuidor').on('click', function() {
            js_general_limpiar_errores(this);
        });
        $('#cmb_anio').on('click', function() {
            js_general_limpiar_errores(this);
        });
     ...
     $('#cmb_distribuidor').on('change', function() {
            ProductosReposicionAdminCaptura_js_combo_anio();
            $('#cmb_anio').val(0);
            $('#cmb_mes').val(0);
        ...
        $('#cmb_anio').on('change', function() {
             ProductosReposicionAdminCaptura_js_combo_mes();
            $('#cmb_mes').val(0);
            $('#cmb_participantes').val(0);
            $('#cmb_premio').val(0);
            $('#fecha_entrega').val('');
        ...
        $('#cmb_mes').on('change', function() {
            ...
            ProductosReposicionAdminCaptura_js_combo_participante();
        ProductosReposicionAdminCaptura_js_fecha_inicio();
        });
        $('#cmb_participantes').on('change', function() {
            ProductosReposicionAdminCaptura_js_combo_premio();
        });
        ...
        $("#reposicionCaptura_boton_guardar").click(function() {
            ProductosReposicionAdminCaptura_js_validar();
        });

    function ProductosReposicionAdminCaptura_js_combo_distribuidora() {
        $('#loader_panel').show();
        $.ajax({
            type: 'POST',
            url: 'productos/productos_reposicion/productos_reposicion_captura/productos_reposicion_captura_admin_controller/productos_reposicion_captura_admin_controller_cmb_distribuidor',
            dataType: 'json',
            data: {
                id: 0
            },
    ...
    function ProductosReposicionAdminCaptura_js_combo_anio() {
        var cmb_distribuidor = $("#cmb_distribuidor").val();
        $('#loader_panel').show();
        $.ajax({
            type: 'POST',
            url: 'productos/productos_reposicion/productos_reposicion_captura/productos_reposicion_captura_admin_controller/productos_reposicion_captura_admin_controller_cmb_anio',
            dataType: 'json',
            data: {
    ...
    function ProductosReposicionAdminCaptura_js_combo_mes() {
        var cmb_distribuidor = $("#cmb_distribuidor").val();
        var anio = $("#cmb_anio").val();
        $('#loader_panel').show();
        $.ajax({
            type: 'POST',
            url: 'productos/productos_reposicion/productos_reposicion_captura/productos_reposicion_captura_admin_controller/productos_reposicion_captura_admin_controller_cmb_mes',
            dataType: 'json',
            data: {
                cmb_distribuidor: cmb_distribuidor,
                anio: anio
    ...
    function ProductosReposicionAdminCaptura_js_update_fotos() {
        $('#loader_panel').show();
        var chk_ganador = $('#chk_ganador').val();
        $.ajax({
            type: 'POST',
            url: 'productos/productos_reposicion/productos_reposicion_captura/productos_reposicion_captura_admin_controller/productos_reposicion_captura_admin_controller_cargas_upload_nombre_foto',
            dataType: 'json',
            data: {
    ...
    function ProductosReposicionAdminCaptura_js_fecha_inicio() {
        $('#loader_panel').show();
        var mes = $('#cmb_mes').val();
        var cmb_distribuidor = $("#cmb_distribuidor").val();
        $.ajax({
            type: 'POST',
            url: 'productos/productos_reposicion/productos_reposicion_captura/productos_reposicion_captura_admin_controller/productos_reposicion_captura_admin_controller_fecha_inicio',
            dataType: 'json',
            data: {
                mes: mes,
                cmb_distribuidor: cmb_distribuidor
    ...
    function ProductosReposicionAdminCaptura_js_combo_participante() {
        $('#loader_panel').show();
        var anio = $('#cmb_anio').val();
        var mes = $('#cmb_mes').val();
        var cmb_distribuidor = $("#cmb_distribuidor").val();
        ...
        $.ajax({
            type: 'POST',
            url: 'productos/productos_reposicion/productos_reposicion_captura/productos_reposicion_captura_admin_controller/productos_reposicion_captura_admin_controller_cmb_participantes',
            dataType: 'json',
            data: {
                mes: mes,
                anio: anio,
    ...
    function ProductosReposicionAdminCaptura_js_combo_premio() {
        var cmb_distribuidor = $("#cmb_distribuidor").val();
        var anio = $('#cmb_anio').val();
        ...
        $.ajax({
            type: "POST",
            url: 'productos/productos_reposicion/productos_reposicion_captura/productos_reposicion_captura_admin_controller/productos_reposicion_captura_admin_controller_cmb_premio',
            dataType: 'json',
            data: {
                cmb_mes: cmb_mes,
    ...
    function ProductosReposicionAdminCaptura_js_validar() {
        $('#error').html(" ");
        $('#loader_panel').show();
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url("productos/productos_reposicion/productos_reposicion_captura/productos_reposicion_captura_admin_controller/productos_reposicion_captura_admin_controller_form_validate") ?>",
            data: {
                cmb_distribuidor: cmb_distribuidor,
                cmb_mes: cmb_mes,
                cmb_participantes: cmb_participantes,
