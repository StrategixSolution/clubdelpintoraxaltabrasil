 ...
 * @CreateDate 15 jun. 2022 16:48:46 * 
 */
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">                
                        <form action="productos/productos_reposicion/productos_reposicion_carga_controller/productos_reposicion_carga_controller_excel" id="frm_productos_reposicion_carga_form_view" role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            <div id="uploadsFiles">
                                <label for="productos_reposicion_carga_controller_lang_file_excel" class="label"><?=$this->lang->line('productos_reposicion_carga_controller_lang_label_selecciona_archivo')?><span data-toggle='tooltip' title='<?=$this->lang->line('productos_reposicion_carga_controller_lang_tooltip_archivo')?>'><i class="fas fa-question-circle"></i></span></label>
...
<script>
    $(document).ready(function(){
        $("#frm_productos_reposicion_carga_form_view").submit(function(event){ event.preventDefault(); });
        $("#carga_btn_subir_archivo").click(function() { productos_reposicion_carga_form_view_js_excel(); }); 
    ...
    function productos_reposicion_carga_form_view_js_excel(){
        ...
        if (productos_reposicion_carga_controller_lang_file_excel!=""){
            ...
            Swal.fire({ icon: 'error', allowOutsideClick:false, text: "<?=$this->lang->line('productos_reposicion_carga_controller_lang_js_msg_archivo_seleccione')?>"});
        }
    }
    'use strict';
