                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row justify-content-center mt-30">
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <p><small><?=$this->lang->line('usuarios_crea_clave_controller_lang_instrucciones')?></small</p>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-recovery animate__animated animate__zoomIn" id="axa-form">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" class="form-control trans" name="clave_nueva" value="" id="clave_nueva" placeholder='<?=$this->lang->line('usuarios_crea_clave_controller_lang_input_clave_nueva_placeholder')?>' aria-describedby="basic-addon1">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-text" id="basic-addon1"><i class="fas fa-key"></i></span>
                                                    <input type="password" name="clave_nueva_confirma" value="" id="clave_nueva_confirma" class="form-control trans" placeholder="<?=$this->lang->line('usuarios_crea_clave_controller_lang_input_clave_nueva_confirma_placeholder')?>" pb-role="clave_nueva_confirma">
                                ...
                                <div class="row justify-content-end mt-50">
                                    <div class="col-3">
                                        <div class="d-grid gap-2">
                                            <button type="button" id="button_crea_clave" class="btn btn-conticlub" pb-role="submit"><?=$this->lang->line('usuarios_crea_clave_controller_lang_msg_btn_guardar')?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    function usuarios_crea_clave_nueva_clave(){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                case 0:
                    $('#clave_nueva').focus();
                        Swal.fire({icon: 'error',title: '',text: '<?=$this->lang->line('usuarios_crea_clave_controller_lang_valida_clave_nueva_confirma_no_concuerdan')?>'});
                    break;
                case 1:
                    Swal.fire({
                        title: '',
                        html: '<?=$this->lang->line('usuarios_crea_clave_controller_lang_actualizada')?>',
                        icon: 'success',
                        showCancelButton: false,
                        confirmButtonColor: '#fd7e14',
                        cancelButtonColor: '#6c757d',
                        confirmButtonText: '<?=$this->lang->line('usuarios_crea_clave_controller_lang_msg_btn_ok')?>',
                        cancelButtonText: ''
