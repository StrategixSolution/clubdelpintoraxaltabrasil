...
<html lang="es-MX">
    ...
    <body>
            <div class="row" style="display: none; position: fixed; width: 100%; height: 150%; background-color: #111; z-index: 9999; opacity: .5; margin: -180px 0px 0px 0px; padding-top:-100px;" id='loader_panel'>
                <img src="<?=funciones_strategix_version_url_random_base_url("application/views/template/sistema/imagenes/cargando.gif")?>" style='width: 400px; height: 400px; margin: auto auto; margin-top:180px;'>
            </div>         
