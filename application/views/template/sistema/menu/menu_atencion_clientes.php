...
<li class="nav-item dropdown" id="nav_catalogos">
            ...
            <li><a class="dropdown-item" href="<?php echo funciones_strategix_version_url_random_base_url("ReporteAuditoriaPromociones"); ?>">RELATÓRIO DE AUDITORIA DE PROMOÇÕES</a></li>
