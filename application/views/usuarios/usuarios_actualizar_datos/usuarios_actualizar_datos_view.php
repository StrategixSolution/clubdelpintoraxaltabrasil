                ...
                <div class="col-lg-12">
                    <div class="form-rf-1 form-pr" id="form-rf-1">
                        ...
                        <div class="row row-validator">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label><?= $this->lang->line('usuarios_actualizar_datos_controller_lang_input_email') ?><span data-toggle='tooltip' title='<?= $this->lang->line('usuarios_actualizar_datos_controller_lang_tooltip_email') ?>'><i class="fas fa-question-circle"></i></span></label>
                                    ...
                                    <!--<label id="validar_email"><?= $this->lang->line('usuarios_actualizar_datos_controller_lang_validar') ?>-->
                                    <div id="error"></div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label><?= $this->lang->line('usuarios_actualizar_datos_controller_lang_input_celular') ?><span data-toggle='tooltip' title='<?= $this->lang->line('usuarios_actualizar_datos_controller_lang_tooltip_celular') ?>'><i class="fas fa-question-circle"></i></span></label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="txt_clave_nueva"><?= $this->lang->line('usuarios_actualizar_datos_controller_lang_input_clave') ?><span data-toggle='tooltip' title='<?= $this->lang->line('usuarios_actualizar_datos_controller_lang_tooltip_clave') ?>'><i class="fas fa-question-circle"></i></span></label>
                        ...
                        <!--<div class="row row-validator">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="txtrfc"><?= $this->lang->line('usuarios_actualizar_datos_controller_lang_input_rfc') ?><span data-toggle='tooltip' title='<?= $this->lang->line('usuarios_actualizar_datos_controller_lang_tooltip_rfc') ?>'><i class="fas fa-question-circle"></i></span></label>
                                    <input type="text" name="txt_rfc" id="txt_rfc" class="form-control txt-mayus" placeholder="<?= $this->lang->line('usuarios_actualizar_datos_controller_lang_placeholder_rfc') ?>" onKeyPress="return js_general_nit(event)" onkeyup="mayus(this);" maxlength="25">
                                    <div id="error"></div>
                                </div>
                            </div>
                        </div>-->
...
<script>
    $(document).ready(function() {
        ...
        /********************************************MSG ERROR******************************************************************************************/
        $('#frm_usuarios_actualizar_datos_admin_view input').on('keyup', function() {
            js_general_limpiar_errores(this);
        });
        $('#frm_usuarios_actualizar_datos_admin_view input').on('click', function() {
            js_general_limpiar_errores(this);
        });
        $('#frm_usuarios_actualizar_datos_admin_view select').on('click', function() {
            js_general_limpiar_errores(this);
        });
        $('#frm_usuarios_actualizar_datos_admin_view input').on('change', function() {
            js_general_limpiar_errores(this);
        });
        /********************************************EYE PARA LA CLAVE******************************************************************************************/
        ...
        /*********************************************BOTON DE GUARDADO*****************************************************************************************/
        $("#usuarios_actualizar_datos_admin_boton_guardar").click(function() {
            usuarios_actualizar_datos_admin_js_guardar();
        });
        ...
        $('#txt_celular').on('change', function() {
            usuarios_actualizar_datos_admin_js_validar_campos();
        });
    });
                ...
                switch (data) {
                    case 1:
                        Swal.fire({
                            icon: 'info',
                            title: '',
                            text: '<?= $this->lang->line('usuarios_actualizar_datos_controller_lang_js_msg_swal_validar_email_activo') ?>'
                        });
                        usuarios_actualizar_datos_admin_js_validar_correo_celular();
                        break;
                    case 2:
                        Swal.fire({
                            icon: 'info',
                            title: '',
                            text: '<?= $this->lang->line('usuarios_actualizar_datos_controller_lang_js_msg_swal_validar_email_enviado') ?>'
                        });
                        usuarios_actualizar_datos_admin_js_validar_correo_celular();
                        break;
                }
