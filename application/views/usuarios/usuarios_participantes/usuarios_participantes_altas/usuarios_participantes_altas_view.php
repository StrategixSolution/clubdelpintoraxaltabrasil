                    ...
                    <div class="form-rf-1 form-pr" id="form-rf-1">
                        ...
                        <div class="row" style="margin-top:20px; text-align:center;">
                            <div class="col-lg-2 offset-lg-8 col-6">
                                <button type="button" onclick="window.location.href='<?= funciones_strategix_version_url_random_base_url("UsuariosParticipantes") ?>'" class="btn btn-gray"><i class="far fa-caret-square-left"></i><span class="btn-buscar-texto"><?= $this->lang->line('usuarios_participantes_altas_controller_lang_boton_regresar') ?></span></button>
                            </div>
                            <div class="col-lg-2 col-6">
                                <button type="button" id="usuarios_participantes_altas_view_boton_guardar" class="btn btn-axalta btn-buscar-ancho"><i class="far fa-save pr-5"></i><span class="btn-buscar-texto"><?= $this->lang->line('usuarios_participantes_altas_controller_lang_boton_guardar') ?></span></button>
                            </div>
                        </div>
                    </div>
                </div>
