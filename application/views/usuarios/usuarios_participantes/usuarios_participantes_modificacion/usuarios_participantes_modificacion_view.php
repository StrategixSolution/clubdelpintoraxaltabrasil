                        ...
                        <div class="row justify-content-end">
                            <div class="col-lg-2 col-6">
                                <button type="button"
                                    ...
                                    class="btn btn-gray btn-buscar-ancho"><i class="far fa-caret-square-left"></i><span class="btn-buscar-texto"><?= $this->lang->line('usuarios_participantes_modificacion_controller_lang_boton_regresar') ?></span>
                                    </button>
                            </div>
                            <div class="col-lg-2 col-6">
                                <button type="button" id="usuarios_participantes_modificacion_view_boton_guardar"
                                    class="btn btn-axalta btn-buscar-ancho"><i class="far fa-save"></i><span class="btn-buscar-texto"><?= $this->lang->line('usuarios_participantes_modificacion_controller_lang_boton_guardar') ?></span>
                                    </button>
                            </div>
                        </div>
                    </div>
