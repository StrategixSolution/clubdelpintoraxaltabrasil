        ...
        <?php if ($total_auditorias_rechazadas > 0) { ?>
            <div>
                <p style="text-align: left;">
                    ...
                    <button id="ventas_auditoria_envio_correos_tabla_view_btn_envio" class="btn btn-axalta btn-buscar-ancho"><i class="fas fa-envelope"></i><span class="btn-buscar-texto">ENVIAR E-MAILS</span></button>
                </p>
            </div>
        <?php } ?>
    </div>
...
<script>
    $(document).ready(function() {
        $("#ventas_auditoria_envio_correos_tabla_view_btn_envio").click(function() {
            ventas_auditoria_envio_correos_tabla_view_js_envios_correos();
        });
