...
<div class="panel-white">
    <div class="row d-flex flex-column align-items-center">
        ...
        <div class="col-lg-2 col-12" style="text-align: right; margin-top:20px;">
            ...
            <div class="table-responsive table-axalta">
                <table class="table table-bordered" id="TbVentasAuditoria">
                    <thead>
                        ...
                        <th><?= $this->lang->line('ventas_auditoria_primera_controller_lang_tabla_nombre') ?></th>
                        ...
                        <th><?= $this->lang->line('ventas_auditoria_primera_controller_lang_tabla_monto_ticket_capturado') ?></th>
                        <th><?= $this->lang->line('ventas_auditoria_primera_controller_lang_tabla_cantidad_productos') ?></th>
                        <th><?= $this->lang->line('ventas_auditoria_primera_controller_lang_tabla_total_cantidad_productos') ?></th>
