...
<script>
    ...
    async function ventas_auditoria_primera_form_view_js_rechazo(VentaAuditoriaId) {
        var inputOptionsPromise = new Promise(function(resolve) {
            ...
            setTimeout(function() {
                $.getJSON("ventas/ventas_auditoria/ventas_auditoria_promociones/ventas_auditoria_promociones_controller/ventas_auditoria_promociones_controller_combo_observaciones", function(data) {
                    resolve(data);
                });
            }, 200);
        });
