                    ...
                    <div class="mb-3" id="div_detalle">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2" style="display: none;" id="div_btn_agregar">
                                <div class="form-group">
                                    <button type="button" id="ventas_registro_boton_agregar" class="btn btn-gray btn-buscar-ancho"
                            ...
                            <div class="col-lg-2" style="display: none;" id="div_btn_limpiar">
                                <div class="form-group">
                                    <button type="button" id="ventas_registro_boton_limpiar_carito" class="btn btn-axalta btn-buscar-ancho"
                    ...
                    <div class="col-lg-2 col-6">
                        <div class="d-grid gap-2">
                            <button type="button" class="btn btn-gray"
                                ...
                                ><i class="far fa-caret-square-left"></i><span class="btn-buscar-texto">VOLTAR</span></button>
                        </div>
                    </div>
                    <div class="col-lg-2 col-6">
                        <div class="d-grid gap-2">
...
<script>
    $(document).ready(function() {
        ...
        /********************************************ON CLICK******************************************************************************************/
        $("#ventas_auditoria_rechazados_actualiza_view_boton_guardar_foto").click(function() {
            ventas_auditoria_rechazados_actualiza_view_js_camara();
        });
        $("#ventas_auditoria_rechazados_actualiza_view_guardar_venta").click(function() {
            ventas_auditoria_rechazados_actualiza_view_js_guardar_venta();
        });
        ...
        /********************************************MSG ERROR******************************************************************************************/
        $('#frm_ventas_auditoria_rechazados_actualiza_view input').on('keyup', function() {
            js_general_limpiar_errores(this);
        });
        $('#frm_ventas_auditoria_rechazados_actualiza_view input').on('click', function() {
            js_general_limpiar_errores(this);
        });
        $('#frm_ventas_auditoria_rechazados_actualiza_view select').on('click', function() {
            js_general_limpiar_errores(this);
        });
        $('#frm_ventas_auditoria_rechazados_actualiza_view input').on('change', function() {
            js_general_limpiar_errores(this);
        });
                    ...
                    switch (data.resultado) {
                        case "0":
                            Swal.fire({
                                icon: 'error',
                                title: '',
                                text: '<?= $this->lang->line('ventas_registro_js_msg_error_guardar_venta') ?>'
                            });
                            break;
                        case 1:
                            Swal.fire({
            ...
            success: function(data) {
                if (data.resultado == 0) {
                    Swal.fire({
                        icon: 'error',
                        title: '',
                        text: '<?= $this->lang->line('ventas_registro_ticket_controller_lang_msg_qr_error') ?>'
                    });
                    $("#txt_qr").val('');
