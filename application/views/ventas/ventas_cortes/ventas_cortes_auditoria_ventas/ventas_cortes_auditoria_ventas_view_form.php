...
<script>
    ...
    $(document).ready( function () {
        ...
        $("#ventas_cambio_estatus_auditar").click(function(){ ventas_cortes_auditoria_ventas_view_form_js_crea_corte(); });
                            ...
                            switch(data.res){
                                ...
                                case 2:
                                    Swal.fire({
                                        ...
                                        if (validacionaltaparticipante.isConfirmed) {location.reload();} 
                                    });
                                    break;
                                case 3:
                                    Swal.fire({
