...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#frm_ventas_promociones_cargas_controller").submit(function(event) {
        ...
        $("#ventas_promociones_cargas_controller_guardar").click(function() {
            ventas_promociones_cargas_controller_excel();
        });
        /********************************************MSG ERROR******************************************************************************************/
        $('#frm_ventas_promociones_cargas_controller input').on('keyup', function() {
            js_general_limpiar_errores(this);
        });
        $('#frm_ventas_promociones_cargas_controller input').on('click', function() {
            js_general_limpiar_errores(this);
        });
        $('#frm_ventas_promociones_cargas_controller select').on('click', function() {
            js_general_limpiar_errores(this);
        });
        $('#frm_ventas_promociones_cargas_controller input').on('change', function() {
            js_general_limpiar_errores(this);
        });
        /**************************************************************************************************************************************/
    });
    ...
    function ventas_promociones_cargas_controller_excel() {
        ...
        if (ventas_promociones_cargas_controller_carga_file_excel != "") {
            ...
            Swal.fire({
                ...
                text: "<?= $this->lang->line('ventas_promociones_cargas_js_msg_archivo') ?>"
            });
        }
    }
    'use strict';;
