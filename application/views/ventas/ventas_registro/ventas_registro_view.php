      ...
      <div class="panel-white">
          ...
          <div class="mb-3" id="div_detalle">
            ...
            <div class="row">
              ...
              <div class="col-lg-2" style="display: none;" id="div_btn_agregar">
                <div class="form-group">
                  <button type="button" id="ventas_registro_boton_agregar" class="btn btn-axalta" style="margin-top:20px;"><i class="fas fa-plus" style="margin-right:10px;"></i> <?= $this->lang->line('ventas_registro_controller_lang_boton_agregar') ?></button>
                </div>
              </div>
              <div class="col-lg-2" style="display: none;" id="div_btn_limpiar">
                <div class="form-group">
                  <button type="button" id="ventas_registro_boton_limpiar_carito" class="btn btn-axalta" style="margin-top:20px;"><i class="fas fa-trash" style="margin-right:10px;"></i><?= $this->lang->line('ventas_registro_controller_lang_boton_limpiar_carrito') ?></button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="margin-top:20px; text-align:center;">
          <div class="col-lg-2 offset-lg-8 col-6">
            <button type="button" onclick="window.location.href='<?= funciones_strategix_version_url_random_base_url("Distribuidores") ?>'" class="btn btn-gray"><i class="far fa-caret-square-left"></i> <?= $this->lang->line('ventas_registro_controller_lang_boton_regresar') ?></button>
          </div>
          <div class="col-lg-2 col-6">
            <button type="button" id="ventas_registro_boton_buscar" class="btn btn-axalta"><i class="far fa-save"></i> <?= $this->lang->line('ventas_registro_controller_lang_boton_guardar') ?></button>
          </div>
        </div>
      </div>
